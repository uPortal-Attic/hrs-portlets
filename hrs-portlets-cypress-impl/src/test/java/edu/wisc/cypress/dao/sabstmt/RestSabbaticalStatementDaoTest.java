...
public class RestSabbaticalStatementDaoTest extends RestSabbaticalStatementDaoIT {
    @Autowired
    ...
    public void testStatement() throws Exception {
        final InputStream sabbaticalStatementsStream = this.getClass().getResourceAsStream("/sampleData/sabbatical-reports.xml");
        assertNotNull(sabbaticalStatementsStream);
        
        setupHttpClient(sabbaticalStatementsStream, "application/octet-stream");
    ...
    public void testGetStatements() throws Exception {
        ...
        setupHttpClient(sabbaticalStatementsStream, "application/xml");
    ...
    public void testNoStatements() throws Exception {
        final InputStream sabbaticalStatementsStream = this.getClass().getResourceAsStream("/sampleData/sabbatical-reports_empty.xml");
        assertNotNull(sabbaticalStatementsStream);
