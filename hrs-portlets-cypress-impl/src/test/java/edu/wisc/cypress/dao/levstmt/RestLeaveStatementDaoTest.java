...
public class RestLeaveStatementDaoTest extends RestLeaveStatementDaoIT {
    @Autowired
    ...
    public void testStatement() throws Exception {
        final InputStream leaveStatementsStream = this.getClass().getResourceAsStream("/sampleData/leave-statements.xml");
        assertNotNull(leaveStatementsStream);
        setupHttpClient(leaveStatementsStream, "application/octet-stream");
    ...
    public void testGetStatements() throws Exception {
        final InputStream leaveStatementsStream = this.getClass().getResourceAsStream("/sampleData/leave-statements.xml");
        assertNotNull(leaveStatementsStream);
        setupHttpClient(leaveStatementsStream, "application/xml");
    ...
    public void testGetMultipleStatements() throws Exception {
        final InputStream leaveStatementsStream = this.getClass().getResourceAsStream("/sampleData/leave-multi-statements.xml");
        assertNotNull(leaveStatementsStream);
        setupHttpClient(leaveStatementsStream, "application/xml");
        
        super.testGetMultipleStatements();
    }

    @Test
    @Override
    public void testNoStatements() throws Exception {
        final InputStream leaveStatementsStream = this.getClass().getResourceAsStream("/sampleData/leave-statements_empty.xml");
        assertNotNull(leaveStatementsStream);
        setupHttpClient(leaveStatementsStream, "application/xml");
