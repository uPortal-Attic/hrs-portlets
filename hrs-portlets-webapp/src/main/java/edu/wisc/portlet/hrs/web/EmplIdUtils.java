...
import edu.wisc.portlet.hrs.security.PrimaryAttributePortletAuthenticationDetails;

/**
 * EmplId access utilities
 * 
 * @author Eric Dalquist
 * @version $Revision: 1.3 $
 */
public final class EmplIdUtils {
    /**
     * @return The current user's EmplID
     */
