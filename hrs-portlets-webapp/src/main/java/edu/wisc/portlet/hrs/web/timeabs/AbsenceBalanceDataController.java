...
@Controller
@RequestMapping("VIEW")
public class AbsenceBalanceDataController {
    private AbsenceBalanceDao absenceBalanceDao;
    
    @Autowired
    public void setAbsenceBalanceDao(AbsenceBalanceDao absenceBalanceDao) {
        this.absenceBalanceDao = absenceBalanceDao;
    }
    ...
    public String getAbsenceBalances(ModelMap modelMap) {
        ...
        modelMap.addAttribute("report", absenceBalances);
