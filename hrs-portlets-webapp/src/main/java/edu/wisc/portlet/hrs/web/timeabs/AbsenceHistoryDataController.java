...
@Controller
@RequestMapping("VIEW")
public class AbsenceHistoryDataController {
private AbsenceHistoryDao absenceHistoryDao;
    
    @Autowired
    public void setAbsenceHistoryDao(AbsenceHistoryDao absenceHistoryDao) {
        this.absenceHistoryDao = absenceHistoryDao;
    }
    ...
    public String getAbsenceHistories(ModelMap modelMap) {
        ...
        modelMap.addAttribute("report", absenceHistories);
