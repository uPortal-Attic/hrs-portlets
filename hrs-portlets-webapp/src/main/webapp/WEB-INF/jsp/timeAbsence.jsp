...
<div id="${n}dl-time-absence" class="fl-widget portlet dl-time-absence">
  ...
  <div>
    ...
    <div class="dl-link">
     ...
     --%>
    <div class="dl-link">
      <a href="${prefs['UnclassifiedLeaveReportUrl'][0]}" target="_blank">Unclassified Leave Report</a> | <a href="${prefs['UnclassifiedLeaveReportForSummerUrl'][0]}" target="_blank">Unclassified Leave Report for the Summer</a>
    </div>
  </div>
</div>
