...
<div id="${n}dl-payroll-information" class="fl-widget portlet dl-payroll-information">
  ...
  <div class="dl-payroll-links">
    <div class="dl-link">
      <a href="https://uwservice.wisc.edu/docs/forms/pay-employee-withholding.pdf" target="_blank">Update your W4</a>
    </div>
    <div class="dl-link">
      <a href="https://uwservice.wisc.edu/docs/forms/pay-direct-deposit.pdf" target="_blank">Update your Direct Deposit</a>
    </div>
    <c:if test="${personalDataError or personalData.onVisa}">
      <div class="dl-link">
        <a href="http://www.online-tax.net/" target="_blank">Glacier International Tax</a>
      </div>
      <c:if test="${personalDataError or personalData.madisonEmpl}">
        <div class="dl-link">
          <a href="https://www.cintax.us/gateway.asp?iid=P2642KCJ" target="_blank">CINTAX Nonresident Tax Preparation</a>
        </div>
      </c:if>
    </c:if>
  </div>
