...
<div class="contact-info-address">
 <h4 class="contact-info-address-type" aria-label="Home address" tabindex="0"><strong><spring:message code="${messagePrefix}Address" /></strong></h4>
  ...
  <div aria-label="phone number" tabindex="0" class="contact-info-phone">
